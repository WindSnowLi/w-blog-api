...
/*!40000 ALTER TABLE `article_label`
    DISABLE KEYS */;
INSERT INTO `article_label`
VALUES (1, 'default', 'https://pic.hiyj.cn/images/2021/05/26/d593adeb90a35948f7f7680a8bf7416b.md.jpg', '未分类、默认分类');
/*!40000 ALTER TABLE `article_label`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `article_map_label`
    DISABLE KEYS */;
...
/*!40000 ALTER TABLE `article_map_type`
    DISABLE KEYS */;
...
/*!40000 ALTER TABLE `comment`
    DISABLE KEYS */;
INSERT INTO `comment`
VALUES (1, 1, 'ARTICLE', 1, NULL, 'PASS', '评论测试', '2021-08-31 17:07:56', NULL);
/*!40000 ALTER TABLE `comment`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `friend_links`
    DISABLE KEYS */;
INSERT INTO `friend_links`
VALUES (1, 'https://www.blog.hiyj.cn/', '绿色小菜狗', '芹菜+白菜+苟=绿色小菜狗', '706623475@qq.com', 'PASS',
        'https://pic.hiyj.cn/images/2021/07/04/7c99ac62e6de300a5256ec3be56cb2a1.md.gif', '2021-08-08 22:35:51',
        '2021-09-02 21:40:00');
/*!40000 ALTER TABLE `friend_links`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'COMMENT', '评论权限', '2021-08-26 11:49:30', '2021-08-26 17:46:13', 'NORMAL'),
       (2, 'BACKGROUND-LOGIN', '后台登陆权限', '2021-08-26 11:50:56', '2021-08-26 17:46:13', 'NORMAL'),
       (3, 'CREATE-ARTICLE', '创建文章权限', '2021-08-26 11:51:37', '2021-08-26 17:46:13', 'NORMAL'),
       (4, 'DELETE-ARTICLE', '删除文章权限', '2021-08-26 11:52:06', '2021-08-26 17:46:13', 'NORMAL'),
       (5, 'GET-ARTICLE', '获取文章权限', '2021-08-26 11:52:48', '2021-08-26 17:46:13', 'NORMAL'),
       (6, 'GET-COMMENT', '获取评论权限', '2021-08-26 11:53:26', '2021-08-26 17:46:13', 'NORMAL'),
       (7, 'VERIFY-COMMENT', '审核评论权限', '2021-08-26 11:54:57', '2021-08-26 17:46:13', 'NORMAL'),
       (8, 'VERIFY-LINK', '审核链接权限', '2021-08-26 11:55:52', '2021-08-26 17:46:13', 'NORMAL'),
       (9, 'UPLOAD-FILE', '上传文件权限', '2021-08-26 11:56:31', '2021-08-26 17:46:13', 'NORMAL'),
       (10, 'UI-SETTING', '设置UI权限', '2021-08-26 11:57:08', '2021-08-26 17:46:13', 'NORMAL'),
       (11, 'STORE-SETTING', '设置存储配置文件权限', '2021-08-26 11:57:54', '2021-08-26 17:46:13', 'NORMAL'),
       (12, 'SYS-SETTING', '系统设置权限', '2021-08-26 11:58:13', '2021-08-26 17:46:13', 'NORMAL'),
       (13, 'USER-BASE-INFO', '用户基础信息设置权限', '2021-08-26 11:58:40', '2021-08-26 17:46:13', 'NORMAL'),
       (14, 'ABOUT-INFO', '关于信息设置权限', '2021-08-26 11:59:01', '2021-08-26 17:46:13', 'NORMAL'),
       (15, 'UPDATE-ARTICLE', '更新文章权限', '2021-08-26 21:26:06', '2021-08-26 21:26:06', 'NORMAL'),
       (16, 'DELETE-FILE', '删除云文件权限', '2021-08-26 21:30:11', '2021-08-26 21:30:11', 'NORMAL'),
       (17, 'UPDATE-ARTICLE-LABEL', '更新分类标签信息', '2021-09-10 11:37:38', '2021-09-10 11:37:38', 'NORMAL');
/*!40000 ALTER TABLE `permission`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `role`
    DISABLE KEYS */;
INSERT INTO `role`
VALUES (2, 'admin', '管理员角色', '2021-08-26 11:47:15', '2021-08-26 16:13:03', 'NORMAL'),
       (3, 'user', '普通用户角色', '2021-08-26 11:47:44', '2021-08-26 12:00:15', 'NORMAL'),
       (4, 'visitor', '访客角色', '2021-08-26 12:00:15', '2021-08-26 12:00:20', 'NORMAL');
/*!40000 ALTER TABLE `role`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `role_map_permission`
    DISABLE KEYS */;
INSERT INTO `role_map_permission`
VALUES (1, 2, 1),
       (2, 2, 2),
       (3, 2, 3),
       (4, 2, 4),
...
(
    ...
    `item`    enum ('main_title','topbar_title','footer','background_list','about','contact', 'include') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '所属配置项',
...
/*!40000 ALTER TABLE `ui_config`
    DISABLE KEYS */;
INSERT INTO `ui_config`
VALUES (119, 1, 'background_list',
        'https://pic.hiyj.cn/images/2021/05/26/40e469f75a6844bb570c6b8481224ae9.jpg\nhttps://pic.hiyj.cn/images/2021/05/26/75512149904ab29eec72d7010c1312e5.jpg\nhttps://pic.hiyj.cn/images/2021/05/26/88833c15c93325785a3a3d4186651755.jpg\nhttps://pic.hiyj.cn/images/2021/05/26/11e4dfc877647d8badeddee94515bd68.jpg'),
       (130, 1, 'about',
        '# w-blog\n\n## 描述\n\n一个后端使用Spring Boot 2.x、前台使用nuxtJs、后台使用vue的个人博客\n\n## 简介\n\n1. 链接\n* Gitee链接：\n   * [api](https://gitee.com/windsnowli/w-blog-api)： `https://gitee.com/windsnowli/w-blog-api`\n\n   * [前台](https://gitee.com/windsnowli/vue-ssr-blog)： `https://gitee.com/windsnowli/vue-ssr-blog`\n\n   * [后台](https://gitee.com/windsnowli/vue-admin-blog)： `https://gitee.com/windsnowli/vue-admin-blog`\n\n* GitHub链接：\n   * [api](https://github.com/WindSnowLi/w-blog-api)： `https://github.com/WindSnowLi/w-blog-api`\n\n   * [前台](https://github.com/WindSnowLi/vue-ssr-blog)： `https://github.com/WindSnowLi/vue-ssr-blog`\n\n   * [后台](https://github.com/WindSnowLi/vue-admin-blog)： `https://github.com/WindSnowLi/vue-admin-blog`\n\n2. 一个简单的的个人博客项目，共分为了 `前台`、 `后台`、 `api`三个部分。\n\n3. api\n   后端基于 `SpringBoot` 。主要依赖 `mybatis` 、 `fastjson` 、 `DruidDataSource` 、 `Lombok` 、 `java-jwt` 、 `aliyun-sdk-oss` 、 `knife4j` 等，数据库使用的是 `MySQL8.0+`\n\n4. 前台\n   前台的主要样式是来源于网络上了一个 `BizBlog` 模板，最初来源于哪我不得而知，在原本的基础上改写成了 `nuxtJs` 项目。\n5. 后台\n   后台UI套用的[vue-element-admin](https://github.com/PanJiaChen/vue-element-admin)，基本是直接拿来用了，想自己定制着实实力不允许。\n6. 示例：[绿色食品——菜狗](https://www.blog.hiyj.cn/)\n\n## 本地启动\n\n### api：前台后台请求的api使用的是同一个项目\n\n1. `git clone https://gitee.com/WindSnowLi/w-blog-api.git`或`git clone https://github.com/WindSnowLi/w-blog-api.git` 克隆项目到本地\n2. `mvn clean install dependency:tree` 安装依赖\n3. 修改开发环境 `application-dev.yml` 和生产环境 `application-prod.yml` 中的数据库配置信息； `knife4j` 只在开发环境中激活。\n4. 创建数据库配置中指定名称的空数据库，`UTF8`编码\n5. `mvn clean package -Dmaven.test.skip=true` 跳过测试并生成 `jar` 包\n6. `java -jar 生成的包名.jar` 运行开发配置环境，初次运行会自动初始化数据库\n7. 访问 `http://127.0.0.1:8888/doc.html` 查看 `api` 文档\n8. *推荐使用IDEA打开项目文件夹自动处理依赖、方便运行*\n\n### 前台\n\n1. `git clone https://gitee.com/WindSnowLi/vue-ssr-blog.git`或`git clone https://github.com/WindSnowLi/vue-ssr-blog.git` 克隆项目到本地\n2. `npm install` 安装依赖\n3. 可修改 `config/sitemap.xml` 文件中的 `host` 地址，用于生成访问地图\n4. 可修改 `nuxt.config.js` 中的端口号\n5. 可修改 `package.json` 文件中的 `script` 中的 `BASE_URL` 来指定后端 `api` 地址\n6. `npm run build` 编译\n7. `npm start` 本地运行\n\n### 后台\n\n1. `git clone https://gitee.com/WindSnowLi/vue-admin-blog.git`或`git clone https://github.com/WindSnowLi/vue-admin-blog.git` 克隆项目到本地\n2. `npm install` 安装依赖\n3. `npm run dev` 使用模拟数据预览界面\n4. 修改 `.env.production` 文件中的 `VUE_APP_BASE_API` 地址为后端 `api` 的地址\n5. `npm run build:prod` 编译\n6. `dist` 文件夹下的为编译好的文件，可放到 `http` 服务器下（可以使用 `npm` 安装 `http-server` ）进行访问\n7. 默认账号:`admin@163.com`,密码:`123456`\n\n## 界面展示\n\n### 前台\n\n![首页](https://pic.hiyj.cn/images/2021/08/30/8be350dc4ad9f76c10f7daa8f0ec2f83.png)\n\n<br>\n\n![文章详情](https://pic.hiyj.cn/images/2021/08/30/d921a4e9d688c8e42e4cb491e81ea29f.png)\n\n<br>\n\n![友链](https://pic.hiyj.cn/images/2021/08/30/1e6a95dba9dffe2c518fb1114d27f9ef.png)\n\n<br>\n\n![关于信息](https://pic.hiyj.cn/images/2021/08/30/2a71cb94b94aed68d5628ee41beb0359.png)\n\n### 后台\n\n![首页](https://pic.hiyj.cn/images/2021/08/30/c058c6879cad0dc8db994a7dc57f1de6.png)\n\n<br>\n\n![创建文章](https://pic.hiyj.cn/images/2021/08/30/5a9b1e429a934801704cc9ef9526ff60.png)\n\n<br>\n\n![管理文章](https://pic.hiyj.cn/images/2021/08/30/b9a4cc395e4e02ff996c198f39c10895.png)\n\n![文章列表](https://pic.hiyj.cn/images/2021/08/30/7e69e00b415213d37034dd49d236d18e.png)\n\n<br>\n\n![友链管理](https://pic.hiyj.cn/images/2021/08/30/2cd2f03ab3eab5ea0e14a7ced2695d09.png)\n\n<br>\n\n![关于信息](https://pic.hiyj.cn/images/2021/08/30/5582f506f1a93b114baef9d9977841ea.png)\n\n## License\n\n[MIT](https://github.com/WindSnowLi/w-blog-api/blob/master/LICENSE)\n\nCopyright (c) 2021 WindSnowLi\n'),
       (131, 1, 'topbar_title', '纯天然色的菜狗'),
       (132, 1, 'main_title', 'WindSnowLi');
/*!40000 ALTER TABLE `ui_config`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user`
VALUES (1, 'admin@163.com', 'b8a1099b57fb53d28fba7d5717e317ea',
        'https://pic.hiyj.cn/images/2021/07/04/7c99ac62e6de300a5256ec3be56cb2a1.gif', 'WindSnowLi', '706623475',
        '倾向于学习C/C++,Python,Java，主要学习后端方向，虽说很菜但很可爱，虽然啥也不会');
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user_map_article`
    DISABLE KEYS */;
...
/*!40000 ALTER TABLE `user_map_file`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `user_map_file`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user_map_role`
    DISABLE KEYS */;
