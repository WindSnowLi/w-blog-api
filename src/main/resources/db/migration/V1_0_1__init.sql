...
CREATE TABLE `article` (
                           ...
                           `publish_type` enum('ORIGINAL','REPRINT','TRANSLATE') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'ORIGINAL' COMMENT '发布类型，默认原创',
                           PRIMARY KEY (`id`)
...
INSERT INTO `article_label` VALUES (1,'default','https://pic.hiyj.cn/images/2021/05/26/d593adeb90a35948f7f7680a8bf7416b.md.jpg','未分类、默认分类');
...
INSERT INTO `role_map_permission` VALUES (1,2,1),(2,2,2),(3,2,3),(4,2,4),(5,2,5),(6,2,6),(7,2,7),(8,2,8),(9,2,9),(10,2,10),(11,2,11),(12,2,12),(13,2,13),(14,2,14),(20,2,15),(21,2,16),(22,2,17),(15,3,1),(16,3,5),(17,3,6),(18,4,5),(19,4,6);
...
CREATE TABLE `sys_setting` (
                               `id` int NOT NULL AUTO_INCREMENT,
                               `item` enum('background_list','oss','other_login','base_sys') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '项',
                               `value` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '值',
                               PRIMARY KEY (`id`),
                               UNIQUE KEY `sys_setting_UN` (`item`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统设置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-10-09 23:14:28